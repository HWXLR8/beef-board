...
const USB_Descriptor_String_t PROGMEM led_name8 = USB_STRING_DESCRIPTOR(L"E1");
const USB_Descriptor_String_t PROGMEM led_name9 = USB_STRING_DESCRIPTOR(L"E2");
const USB_Descriptor_String_t PROGMEM led_name10 = USB_STRING_DESCRIPTOR(L"E3");
const USB_Descriptor_String_t PROGMEM led_name11 = USB_STRING_DESCRIPTOR(L"E4");
